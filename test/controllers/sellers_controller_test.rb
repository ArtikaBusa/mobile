...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { address: @seller.address, contact_no: @seller.contact_no, email: @seller.email, name: @seller.name } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { address: @seller.address, contact_no: @seller.contact_no, email: @seller.email, name: @seller.name } }
